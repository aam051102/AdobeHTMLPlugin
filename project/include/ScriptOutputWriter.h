...
#ifndef SCRIPT_OUTPUT_WRITER_H_
#define SCRIPT_OUTPUT_WRITER_H_
...
namespace AnimeJS
{
    ...
    public:
        ...
        virtual FCM::Result DefineSound(
            ...
            const std::string& libPathName,
            DOM::LibraryItem::PIMediaItem pMediaItem);
        ScriptOutputWriter(FCM::PIFCMCallback pCallback);

        virtual ~ScriptOutputWriter();
    ...
    private:
        ...
        std::string m_outputScriptFilePath;

        std::string m_outputScriptFileName;
    ...
    public:
        ...
        ScriptTimelineWriter(FCM::PIFCMCallback pCallback);

        virtual ~ScriptTimelineWriter();
